package com.dgutforum.global;


import com.dgutforum.common.exception.ForumException;
...
import com.dgutforum.common.util.JsonUtil;
...
public class ForumExceptionHandler implements HandlerExceptionResolver {
    ...
    private Status buildToastMsg(Exception ex) {
        if (ex instanceof ForumException) {
            ...
            log.error("unexpect NestedRuntimeException error!", ex);
